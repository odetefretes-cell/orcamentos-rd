...
11b. **Integração fiscal OPHOS — `obs-fiscal-service/` (retomado 11/09/2026; NÃO confundir com o item 11):** há DOIS esforços fiscais no repositório e eles são diferentes:
   ...
   - **Custo (31/08, sem fidelidade):** R$ 340 de ativação + **R$ 295,12/mês** na faixa de 100, que é a certa para o volume real (129, 142 e 93 CT-e nos últimos meses, média 122; virada para a faixa de 200 por volta de 163 doc/mês). O plano WEB atual **continua cobrado à parte** e seu valor não foi informado.
   - **O que trava hoje NÃO é técnico:** a proposta de 31/08 está **sem resposta da OBS**, e o cronograma só vem depois do "ok". As 8 perguntas em aberto estão no README do serviço.
